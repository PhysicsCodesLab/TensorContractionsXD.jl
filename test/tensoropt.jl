...
@testset "Optimal contraction order" begin
    ...
    @test cost == TensorOperationsXD.Poly{:χ,Int}([0,0,0,0,0,0,2,2,2])
    ...
    @test cost == TensorOperationsXD.Poly{:χ,Int}([0,0,0,0,0,0,0,0,0,5,5,0,1,1,3,0,3])
    ...
    @test cost == TensorOperationsXD.Poly{:χ,Int}([0,0,0,0,0,0,0,4,4,0,0,0,1,1,1,0,1,0,0,0,3,0,3,2,0,2,4])
end
